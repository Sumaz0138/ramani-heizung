...
export default function RamaniHeader() {
  ...
  // Auf der Startseite reiner Anker (sanftes Scrollen),
  // auf Unterseiten echter Weg zur Startseite + Anker.
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8">
        {/* Logo */}
        <a href={isHome ? "#top" : "/"} className="flex items-center gap-2.5">
          <span className="grid h-10 w-10 place-items-center rounded-xl bg-gradient-to-br from-orange-500 to-orange-400 shadow-lg shadow-orange-500/30">
          ...
          <nav className="mx-auto flex max-w-7xl flex-col gap-1 px-5 py-4">
            {NAV_LINKS.map((link) => (
              <a
                ...
                className="rounded-lg px-3 py-3 text-base font-medium text-gray-800 transition-colors hover:bg-orange-50 hover:text-orange-600"
              >
                {link.label}
              </a>
            ))}
